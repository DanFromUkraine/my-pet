...
function vn() {
  if (!Il && Ae !== null) {
    ...
    try {
      ...
      throw (Ae !== null && (Ae = Ae.slice(e + 1)), Es(Xu, vn), l);
    } finally {
      (O = n), (Il = !1);
    }
  }
...
function ja(e) {
  ...
  n !== null && ((e.alternate = null), ja(n)),
    ...
    e.tag === 5 &&
      ((n = e.stateNode),
      n !== null &&
        (delete n[Fe], delete n[At], delete n[vu], delete n[Kf], delete n[Yf])),
    (e.stateNode = null),
    (e.return = null),
    (e.dependencies = null),
...
ec(document.getElementById("root")).render(
  Ie.jsx(Au.StrictMode, { children: Ie.jsx(Rd, {}) })
);
